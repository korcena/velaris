...
describe("describeExecutionEvent mapping", () => {
  const cases: Array<{
    ...
    { type: "message", payload: { plan: true, subtasks: [{ planId: "s0", title: "A" }, { planId: "s1", title: "B" }] }, label: "Plan drafted — 2 subtasks", tone: "gold", kind: "text", text: "s0: A\ns1: B" },
    { type: "message", payload: { plan: true, revision: true, added: ["r0"], cancelled: [], changed: ["s1"] }, label: "Plan revised", tone: "gold", kind: "text", text: "1 added · 0 cancelled · 1 changed" },
